...
uint8_t UCB0_I2CMaster_GotNack(void);

// Fonction indiquant si la lecture est termin�e
uint8_t UCB0_I2CMaster_Previous_ReadBytes_Finished(void);

// Fonction indiquant si la lecture index�e est termin�e
uint8_t UCB0_I2CMaster_Previous_ReadBytesIndexed_Finished(void);

// Fonction indiquant si l'�criture est termin�e
uint8_t UCB0_I2CMaster_Previous_WriteBytes_Finished(void);

// Fonction indiquant si l'�criture index�e est termin�e
uint8_t UCB0_I2CMaster_Previous_WriteBytesIndexed_Finished(void);
